...
if !BanWeapons[ply:GetActiveWeapon():GetClass()] and checkDelay() and button == KEY_O then
...
if !BanWeapons[ply:GetActiveWeapon():GetClass()] and checkDelay() and button == KEY_I then
setDelay(3)
ply.ShouldBreak = false
ply.ShouldStopSwitchWeapon = true
